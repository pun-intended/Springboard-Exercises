...
p0 = Pet(name="joseph", age="10", species="cat", available=False)
...
p6 = Pet(name="dumbo", age="2", species="porcupine", available=False)
p7 = Pet(name="one", age="15", species="dog", available=False)
