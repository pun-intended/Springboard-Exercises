/*
Write a function called hasOddNumber which accepts an array and returns true if the 
array contains at least one odd number, otherwise it returns false.
...
function hasAZero(num) {
    ...
    return numArray.some(function(item){
        return item == 0;
    })
